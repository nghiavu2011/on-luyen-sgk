    ...
    "chapters": [
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Đăm Săn chiến thắng Mtao Mxây",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Rama buộc tội và Hê-ra-clét đi tìm táo vàng",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Mùa xuân chín (Hàn Mặc Tử) và Cảm xúc mùa thu (Đỗ Phủ)",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Tự tình II (Hồ Xuân Hương) và Thực hành tiếng Việt",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Hịch tướng sĩ (Trần Quốc Tuấn)",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Tuyên ngôn Độc lập (Hồ Chí Minh)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Xúy Vân giả dại (Trích chèo Kim Nham)",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Huyện đường (Trích tuồng Nghêu, Sò, Ốc, Hến)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Kĩ năng phân tích đặc trưng thể loại văn học",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Thực hành viết bài văn nghị luận văn học chuẩn GDPT 2018",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Bình Ngô đại cáo (Nguyễn Trãi)",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Bảo kính cảnh giới - bài 43 và Thư lại dụ Vương Thông",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Người cầm quyền khôi phục uy quyền (V. Huy-gô)",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Dưới bóng hoàng lan (Thạch Lam)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Phục hồi và bảo tồn di sản văn hóa Việt Nam",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Phương tiện giao tiếp phi ngôn ngữ trong văn bản thông tin",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khát vọng tuổi trẻ và trách nhiệm công dân",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Thực hành viết bài văn nghị luận xã hội về một vấn đề đời sống",
            "hasRealContent": true
          }
        ],
        "concepts": [
    ...
    "chapters": [
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Vocabulary & Pronunciation /br/, /kr/, /tr/",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Grammar: Present Simple vs. Present Continuous",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Vocabulary & Green Living",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Grammar: Will vs. Be going to & Passive Voice",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Vocabulary & Pronunciation /eɪ/, /aɪ/, /ɔɪ/",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Compound sentences & Infinitives (to V / V-bare)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Volunteer Work Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Past Simple vs. Past Continuous & -ed/-ing Adjectives",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Inventions & Digital Devices Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Present Perfect & Expressing Purpose (used for V-ing / used to V)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Gender Equality & Careers Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Passive Voice with Modals (modal + be + V3)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: International Organisations Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Comparative and Superlative Adjectives",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Digital Learning Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Defining Relative Clauses (Who, Which, That, Whose)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Environmental Protection Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Reported Speech (Backshift of tenses and pronouns)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Lesson 1: Ecotourism & Travel Vocabulary",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Lesson 2: Conditional Sentences Type 1 & Type 2",
            "hasRealContent": true
          }
        ],
        "concepts": [
    ...
    "chapters": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Văn minh Ai Cập, Lưỡng Hà, Ấn Độ và Trung Hoa",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Văn minh Hy Lạp, La Mã và Văn minh thời Phục hưng",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Cách mạng công nghiệp lần thứ nhất và lần thứ hai",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Cách mạng công nghiệp lần thứ ba và lần thứ tư (4.0)",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Cơ sở hình thành và phát triển văn minh Đông Nam Á",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Thành tựu văn hóa tiêu biểu của Đông Nam Á",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Văn minh Văn Lang - Âu Lạc, Chăm-pa và Phù Nam",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Văn minh Đại Việt thời kì Lý - Trần - Lê",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Các dân tộc trên đất nước Việt Nam",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Khối đại đoàn kết dân tộc và chính sách dân tộc của Đảng, Nhà nước",
            "hasRealContent": true
          }
        ],
        "concepts": [
    ...
    "chapters": [
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Một số phương pháp biểu hiện các đối tượng địa lí trên bản đồ",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Sử dụng bản đồ trong học tập và đời sống",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Trái Đất trong hệ Mặt Trời và chuyển động tự quay",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Chuyển động của Trái Đất quanh Mặt Trời và các hệ quả địa lí",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Thạch quyển và thuyết kiến tạo mảng",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Tác động của nội lực và ngoại lực đến địa hình bề mặt Trái Đất",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khí quyển, nhiệt độ không khí và khí áp",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Gió và sự phân bố lượng mưa trên Trái Đất",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Thủy quyển và nước trên lục địa",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Nước biển và đại dương: Sóng, thủy triều, dòng biển",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Đất và các nhân tố hình thành đất",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Sinh quyển và sự phân bố sinh vật trên Trái Đất",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Quy luật thống nhất và hoàn chỉnh của lớp vỏ địa lí",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Quy luật địa đới và quy luật phi địa đới",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Gia tăng dân số và cơ cấu dân số thế giới",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Phân bố dân cư và quá trình đô thị hóa",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Địa lí ngành nông nghiệp, lâm nghiệp và thủy sản",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Địa lí ngành công nghiệp",
            "hasRealContent": true
          },
          {
            "id": "l03",
            "title": "Bài 3: Địa lí ngành dịch vụ, giao thông và thương mại",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Môi trường và tài nguyên thiên nhiên",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Phát triển bền vững và tăng trưởng xanh",
            "hasRealContent": true
          }
        ],
        "concepts": [
    ...
    "chapters": [
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Các hoạt động kinh tế cơ bản",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Các chủ thể của nền kinh tế",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khái niệm và chức năng của thị trường",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Cơ chế thị trường, quy luật cung cầu và giá cả",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khái niệm và vai trò của Ngân sách nhà nước",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Quyền và nghĩa vụ của công dân đối với Ngân sách nhà nước",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khái niệm và các loại thuế cơ bản",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Quyền và nghĩa vụ nộp thuế của công dân",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Sản xuất kinh doanh và các mô hình tổ chức",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Lập kế hoạch kinh doanh và khởi nghiệp",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khái niệm và các hình thức tín dụng",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Sử dụng dịch vụ tín dụng an toàn và phòng ngừa tín dụng đen",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Kế hoạch tài chính cá nhân và các mục tiêu tài chính",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Thực hành lập kế hoạch tài chính cá nhân",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Hệ thống chính trị nước Cộng hòa Xã hội Chủ nghĩa Việt Nam",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Hiến pháp nước CHXHCN Việt Nam và bộ máy nhà nước",
            "hasRealContent": true
          }
        ],
        "concepts": [
      ...
      },
      {
        ...
        "lessons": [
          {
            "id": "l01",
            "title": "Bài 1: Khái niệm, bản chất và vai trò của pháp luật",
            "hasRealContent": true
          },
          {
            "id": "l02",
            "title": "Bài 2: Thực hiện pháp luật và các hình thức xử lí vi phạm",
            "hasRealContent": true
          }
        ],
        "concepts": [
